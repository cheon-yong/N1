...
#include "N1SystemStatics.generated.h"
...
UCLASS()
class UN1SystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "N1", meta = (WorldContext = "WorldContextObject"))
