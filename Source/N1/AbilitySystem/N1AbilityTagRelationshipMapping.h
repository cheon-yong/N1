...
#include "N1AbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FN1AbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UN1AbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
	...
	TArray<FN1AbilityTagRelationship> AbilityTagRelationships;
