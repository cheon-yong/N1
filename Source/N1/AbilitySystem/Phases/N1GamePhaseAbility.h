...
#include "N1GamePhaseAbility.generated.h"
...
class UN1GamePhaseAbility : public UN1GameplayAbility
{
	GENERATED_BODY()

public:

	UN1GamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "N1|Game Phase")
