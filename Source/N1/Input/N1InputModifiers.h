...
#include "N1InputModifiers.generated.h"

struct FInputActionValue;

class FProperty;
class UEnhancedPlayerInput;
class UN1AimSensitivityData;
class UObject;
...
class UN1SettingBasedScalar : public UInputModifier
{
	GENERATED_BODY()
...
UENUM()
enum class EN1TargetingType : uint8
{
...
class UN1InputModifierGamepadSensitivity : public UInputModifier
{
	...
	UPROPERTY(EditInstanceOnly, BlueprintReadWrite, Category = Settings, Config)
	EN1TargetingType TargetingType = EN1TargetingType::Normal;

	/** Asset that gives us access to the float scalar value being used for sensitivty */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, meta = (AssetBundles = "Client,Server"))
	TObjectPtr<const UN1AimSensitivityData> SensitivityLevelTable;
