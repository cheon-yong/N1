...
#include "N1InputUserSettings.generated.h"

/**
 * Custom settings class for any input related settings for the N1 game.
 * This will be serialized out at the same time as the N1 Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS()
class N1_API UN1InputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
	public:
 ...
 */
UCLASS()
class N1_API UN1PlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
