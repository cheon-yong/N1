...
#include "N1InputModifiers.h"

#include "EnhancedPlayerInput.h"
#include "GameFramework/PlayerController.h"
#include "Input/N1AimSensitivityData.h"
#include "Player/N1LocalPlayer.h"
#include "Settings/N1SettingsShared.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(N1InputModifiers)

DEFINE_LOG_CATEGORY_STATIC(LogN1InputModifiers, Log, All);

//////////////////////////////////////////////////////////////////////
// N1InputModifiersHelpers

namespace N1InputModifiersHelpers
{
	/** Returns the owning N1LocalPlayer of an Enhanced Player Input pointer */
	static UN1LocalPlayer* GetLocalPlayer(const UEnhancedPlayerInput* PlayerInput)
	{
		if (PlayerInput)
		{
			if (APlayerController* PC = Cast<APlayerController>(PlayerInput->GetOuter()))
			{
				return Cast<UN1LocalPlayer>(PC->GetLocalPlayer());
			}
		}
		return nullptr;
	}
...
//////////////////////////////////////////////////////////////////////
// UN1SettingBasedScalar

FInputActionValue UN1SettingBasedScalar::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	{
		if (UN1LocalPlayer* LocalPlayer = N1InputModifiersHelpers::GetLocalPlayer(PlayerInput))
		{
			const UClass* SettingsClass = UN1SettingsShared::StaticClass();
			UN1SettingsShared* SharedSettings = LocalPlayer->GetSharedSettings();
...
//////////////////////////////////////////////////////////////////////
// UN1InputModifierDeadZone

FInputActionValue UN1InputModifierDeadZone::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	EInputActionValueType ValueType = CurrentValue.GetValueType();
	UN1LocalPlayer* LocalPlayer = N1InputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (ValueType == EInputActionValueType::Boolean || !LocalPlayer)
	{
		return CurrentValue;
	}

	UN1SettingsShared* Settings = LocalPlayer->GetSharedSettings();
	ensure(Settings);
...
FLinearColor UN1InputModifierDeadZone::GetVisualizationColor_Implementation(FInputActionValue SampleValue, FInputActionValue FinalValue) const
{
...
//////////////////////////////////////////////////////////////////////
// UN1InputModifierGamepadSensitivity

FInputActionValue UN1InputModifierGamepadSensitivity::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	const EN1GamepadSensitivity Sensitivity = (TargetingType == EN1TargetingType::Normal) ? Settings->GetGamepadLookSensitivityPreset() : Settings->GetGamepadTargetingSensitivityPreset();
...
//////////////////////////////////////////////////////////////////////
// UN1InputModifierAimInversion

FInputActionValue UN1InputModifierAimInversion::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	UN1LocalPlayer* LocalPlayer = N1InputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (!LocalPlayer)
	{
