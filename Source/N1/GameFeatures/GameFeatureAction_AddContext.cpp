...
void UGameFeatureAction_AddContext::OnGameFeatureRegistering()
{
...
void UGameFeatureAction_AddContext::OnGameFeatureActivating(FGameFeatureActivatingContext& Context)
{
...
void UGameFeatureAction_AddContext::OnGameFeatureDeactivating(FGameFeatureDeactivatingContext& Context)
{
...
void UGameFeatureAction_AddContext::OnGameFeatureUnregistering()
{
...
#if WITH_EDITOR
EDataValidationResult UGameFeatureAction_AddContext::IsDataValid(FDataValidationContext& Context) const
{
...
void UGameFeatureAction_AddContext::RegisterInputMappingContexts()
{
	RegisterInputContextMappingsForGameInstanceHandle = FWorldDelegates::OnStartGameInstance.AddUObject(this, &UGameFeatureAction_AddContext::RegisterInputContextMappingsForGameInstance);
...
void UGameFeatureAction_AddContext::RegisterInputContextMappingsForGameInstance(UGameInstance* GameInstance)
{
	if (GameInstance != nullptr && !GameInstance->OnLocalPlayerAddedEvent.IsBoundToObject(this))
	{
		GameInstance->OnLocalPlayerAddedEvent.AddUObject(this, &UGameFeatureAction_AddContext::RegisterInputMappingContextsForLocalPlayer);
		GameInstance->OnLocalPlayerRemovedEvent.AddUObject(this, &UGameFeatureAction_AddContext::UnregisterInputMappingContextsForLocalPlayer);
...
void UGameFeatureAction_AddContext::RegisterInputMappingContextsForLocalPlayer(ULocalPlayer* LocalPlayer)
{
...
void UGameFeatureAction_AddContext::UnregisterInputMappingContexts()
{
...
void UGameFeatureAction_AddContext::UnregisterInputContextMappingsForGameInstance(UGameInstance* GameInstance)
{
...
void UGameFeatureAction_AddContext::UnregisterInputMappingContextsForLocalPlayer(ULocalPlayer* LocalPlayer)
{
	if (ensure(LocalPlayer))
	{
		if (UEnhancedInputLocalPlayerSubsystem* EISubsystem = ULocalPlayer::GetSubsystem<UEnhancedInputLocalPlayerSubsystem>(LocalPlayer))
...
void UGameFeatureAction_AddContext::AddToWorld(const FWorldContext& WorldContext, const FGameFeatureStateChangeContext& ChangeContext)
{
...
void UGameFeatureAction_AddContext::Reset(FPerContextData& ActiveData)
{
...
void UGameFeatureAction_AddContext::HandleControllerExtension(AActor* Actor, FName EventName, FGameFeatureStateChangeContext ChangeContext)
{
...
void UGameFeatureAction_AddContext::AddInputMappingForPlayer(UPlayer* Player, FPerContextData& ActiveData)
{
...
void UGameFeatureAction_AddContext::RemoveInputMapping(APlayerController* PlayerController, FPerContextData& ActiveData)
{
