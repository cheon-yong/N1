...
#include "AnimNotify_N1ContextEffects.generated.h"

/**
 *
 */
USTRUCT(BlueprintType)
struct N1_API FN1ContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct N1_API FN1ContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct N1_API FN1ContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct N1_API FN1ContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
	...
	// Preview Library
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Preview, meta = (AllowedClasses = "/Script/N1Game.N1ContextEffectsLibrary"))
...
class N1_API UAnimNotify_N1ContextEffects : public UAnimNotify
{
	GENERATED_BODY()

public:
	UAnimNotify_N1ContextEffects();
	...
	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FN1ContextEffectAnimNotifyVFXSettings VFXProperties;

	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FN1ContextEffectAnimNotifyAudioSettings AudioProperties;
	...
	FN1ContextEffectAnimNotifyTraceSettings TraceProperties;
	...
	FN1ContextEffectAnimNotifyPreviewSettings PreviewProperties;
#endif
