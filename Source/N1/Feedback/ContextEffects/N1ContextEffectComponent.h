...
#include "N1ContextEffectComponent.generated.h"
...
class N1_API UN1ContextEffectComponent : public UActorComponent, public IN1ContextEffectsInterface
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UN1ContextEffectComponent();
...
public:
	...
	UPROPERTY(EditAnywhere)
	TSet<TSoftObjectPtr<UN1ContextEffectsLibrary>> DefaultContextEffectsLibraries;

	UFUNCTION(BlueprintCallable)
	void UpdateEffectContexts(FGameplayTagContainer NewEffectContexts);

	UFUNCTION(BlueprintCallable)
	void UpdateLibraries(TSet<TSoftObjectPtr<UN1ContextEffectsLibrary>> NewContextEffectsLibraries);
...
private:
	...
	UPROPERTY(Transient)
	TSet<TSoftObjectPtr<UN1ContextEffectsLibrary>> CurrentContextEffectsLibraries;
