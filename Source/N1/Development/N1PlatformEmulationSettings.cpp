...
#include "N1PlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(N1PlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "N1Cheats"

UN1PlatformEmulationSettings::UN1PlatformEmulationSettings()
{
}

FName UN1PlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UN1PlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UN1PlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UN1PlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UN1PlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UN1PlatformEmulationSettings::PostInitProperties()
{
...
void UN1PlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UN1PlatformEmulationSettings::ApplySettings()
{
...
void UN1PlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UN1PlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UN1PlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UN1PlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
