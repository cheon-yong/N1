...
class N1_API UN1PawnExtensionComponent : public UPawnComponent, public IGameFrameworkInitStateInterface
{
	...
	UN1PawnExtensionComponent(const FObjectInitializer& ObjectInitializer);
	...
	static UN1PawnExtensionComponent* FindPawnExtensionComponent(const AActor* Actor) { return (Actor ? Actor->FindComponentByClass<UN1PawnExtensionComponent>() : nullptr); }
...
protected:
	...
	UPROPERTY(EditInstanceOnly, ReplicatedUsing = OnRep_PawnData, Category = "N1|Pawn")
