...
public:
	...
	TObjectPtr<UN1InventoryItemInstance> Item = nullptr;
};
...
public:
	...
	static void AddPickupToInventory(UN1InventoryManagerComponent* InventoryComponent, TScriptInterface<IPickupable> Pickup);
};
