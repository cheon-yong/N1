...
#include "N1TaggedWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(N1TaggedWidget)

//@TODO: The other TODOs in this file are all related to tag-based showing/hiding of widgets, see UE-142237

UN1TaggedWidget::UN1TaggedWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UN1TaggedWidget::NativeConstruct()
{
...
void UN1TaggedWidget::NativeDestruct()
{
	if (!IsDesignTime())
	{
...
void UN1TaggedWidget::SetVisibility(ESlateVisibility InVisibility)
{
...
void UN1TaggedWidget::OnWatchedTagsChanged()
{
	const bool bHasHiddenTags = false;//@TODO: Foo->HasAnyTags(HiddenByTags);
