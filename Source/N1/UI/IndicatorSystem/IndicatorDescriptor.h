...
class N1_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UN1IndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UN1IndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UN1IndicatorManagerComponent> ManagerPtr;
